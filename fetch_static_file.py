...
urllib.request.urlretrieve("https://unpkg.com/@popperjs/core@2.10.1/dist/umd/popper.min.js.map", pathlib.PurePath(js_directory,"popper.min.js.map" ))
...
urllib.request.urlretrieve("https://cdn.plot.ly/plotly-2.5.1.min.js",pathlib.PurePath(js_directory,"plotly-2.5.1.min.js" ))



urllib.request.urlretrieve("https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css.map", pathlib.PurePath(bootstrap_directory,"bootstrap.min.css.map" ))
urllib.request.urlretrieve("https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.js.map",pathlib.PurePath(js_directory,"bootstrap-select.js.map" ))
urllib.request.urlretrieve("https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/css/bootstrap-select.css.map", pathlib.PurePath(bootstrap_directory,"bootstrap-select.css.map" ))



urllib.request.urlretrieve("https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.bundle.min.js.map",pathlib.PurePath(js_directory,"bootstrap.bundle.min.js.map" ))


urllib.request.urlretrieve("https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@2.0.0/dist/tf.min.js.map",pathlib.PurePath(js_directory,"tf.min.js.map" ))
